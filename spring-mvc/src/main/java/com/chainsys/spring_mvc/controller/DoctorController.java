...
public class DoctorController {
	...
	public String showModifiedDoctor(@RequestParam("id") int id, Model model) {
		Doctor dr = doctorService.findById(id);
	...
	public String modifyDoctor(@ModelAttribute("modifydoctor") Doctor thedoctor) {
	...
	public String getAllDoctor(Model model) {
		List<Doctor> getAllDoctors = doctorService.getdoctors();
